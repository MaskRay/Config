...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(company-lsp llvm-mode (lsp-ui :location (recipe :fetcher github :repo "emacs-lsp/lsp-ui")))
