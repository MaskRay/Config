...
zstyle ':completion::complete:feh:*' file-patterns '*.{gif,png,jpeg,jpg,svg,webp}:images:images *(-/):directories:directories'
zstyle ':completion::complete:geeqie:*' file-patterns '*.{gif,png,jpeg,jpg,svg,webp}:images:images *(-/):directories:directories'
...
if [[ -f ~/bin/modulecmd.tcl ]]; then
  ...
  module use ~/.modules
  module load go nim ruby rust #wasm nodejs yarn
fi
