;;; private/my/autoload.el -*- lexical-binding: t; -*-
...
(defun +my/find-definitions ()
  (interactive)
  (if lsp-mode (lsp-ui-peek-find-definitions) (+lookup/definition)))

;;;###autoload
(defun +my/find-references ()
  (interactive)
  (if lsp-mode (lsp-ui-peek-find-references) (+lookup/references)))
