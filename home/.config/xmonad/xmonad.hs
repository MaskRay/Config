...
myKeys =
    ...
    , ("M-<Return>", spawn "mlterm" >> sendMessage (JumpToLayout "ResizableTall"))
...
myTopics =
    ...
    , TI "nvim" "" (spawn (mlterm "sh -c \"NVIM_LISTEN_ADDRESS=$XDG_RUNTIME_DIR/nvim nvim\"")) "gvim.xpm"
    , TI "term" "" (spawn $ mlterm "tmux attach -t default") "xterm.xpm"
